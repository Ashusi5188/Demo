...
@Ashusi5188 
209
94 @jonicojonico/Jenkinsfile
Last active 10 hours ago • 
 
<script src="https://gist.github.com/jonico/e205b16cf07451b2f475543cf1541e70.js"></script>
  
 Code  Revisions 6  Stars 209  Forks 94
...
def getCurrentHerokuReleaseDate(app, version) {
 ...
 @roman
roman commented on Dec 8, 2017
This example is very helpful, thanks for sharing

 @exuperok
exuperok commented on Mar 5, 2018
what do you mean by $ref? branch? commit? a combination of both?

 @pabduran
pabduran commented on May 21, 2018
thanks for sharing!!!

 @wender-firmino-aurea
wender-firmino-aurea commented on May 31, 2018
amazing thanks for share this!

 @eltincho89
eltincho89 commented on Jun 22, 2018
thanks for sharing!!!

 @moh-abk
moh-abk commented on Jul 17, 2018
What does ${env.JOB_NAME} look like? Any help appreciated. Seems it's a url.

 @madsop
madsop commented on Aug 2, 2018
Thanks for sharing!
...
@moh-abk: It's a built in Jenkins environment variable. See https://wiki.jenkins.io/display/JENKINS/Building+a+software+project
 ...
 @KristianWindsor
KristianWindsor commented on Dec 8, 2018
This is very helpful, thank you.

 @almeidh
almeidh commented on Jan 15
